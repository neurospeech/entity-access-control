...
namespace NeuroSpeech.EntityAccessControl
{
    ...
    //    //public static IQueryable<T> Where<T>(this IQueryable<T> @this, Expression<Func<T,bool>> filter)
    //    //    where T: class
    //    //{
    ...
    //    //public static IQueryable<T> Requires<T>(this IQueryable<T> @this, Expression<Func<T, bool>> filter)
    //    //    where T : class
    //    //{
    //    //    return ((QueryContext<T>)@this).Requires(filter);
    //    //}

    //    public static IQueryable<T2> Select<T, T2>(this IQueryable<T> @this, Expression<Func<T, T2>> expression)
    //        where T : class
    //        where T2: class
    //    {
