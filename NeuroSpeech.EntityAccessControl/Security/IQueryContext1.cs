...
namespace NeuroSpeech.EntityAccessControl
{
    ...
    public interface IIncludableQueryContext<out T, out TP> : IQueryContext<T>
    {
        ...
        IIncludableQueryContext<T, TProperty> AsCollectionThenInclude<TPreviousProperty, TProperty>(Expression<Func<TPreviousProperty, TProperty>> path) where TPreviousProperty : class;
    }
